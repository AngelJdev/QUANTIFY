...
const transporter = nodemailer.createTransport({
    ...
    tls: {
        // Only disable in development. Many Windows antivirus tools (Kaspersky,
        // ESET, Avast, etc.) intercept SMTP/TLS with their own self-signed cert
        // for "mail scanning", which Node rejects by default.
